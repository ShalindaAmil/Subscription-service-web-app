...
// //const stripePromise = loadStripe('pk_test_51PVpBEHVSy7hcvXHUCFzluLFHFbIQhkTzb0owbX4WXJmaQipWQYzMYDsNrIl6PVq7ilR80BeRtFQPi7YUcg2CeD800gpsAW0Tx');
...
//       if (response.data.success) {
//         const { session_url } = response.data;
//         console.log("Received session URL: ", session_url); // Log the session URL
//         window.location.replace(session_url);
//       } else {
//         alert("Error");
//       }
